...
# Inherit the env-file as the baseline. Only pass these knobs through when the
# caller explicitly sets them; otherwise this sweep would silently fork the
# canonical DSpark speed lane.
for name in \
